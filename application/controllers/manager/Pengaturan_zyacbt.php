...
class Pengaturan_zyacbt extends Member_Controller
{
	...
	public function index($page = null, $id = null)
	{
		...
		$this->template->display_admin($this->kelompok . '/pengaturan_zyacbt_view', 'Pengaturan SMK BPI', $data);
	}
	...
	function simpan()
	{
		...
		$this->form_validation->set_rules('zyacbt-nama', 'Nama SMK BPI', 'required|strip_tags');
		$this->form_validation->set_rules('zyacbt-keterangan', 'Keterangan SMK BPI', 'required|strip_tags');
