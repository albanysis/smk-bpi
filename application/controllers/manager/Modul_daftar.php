			...
			$jawaban_table = '
            	<table class="table" border="0">
            		<tr>
                      ...
                      <td width="15%"><a href="' . base_url() . '/manager/modul_soal/index/' . $temp->soal_id . '" title="Edit Soal" style="cursor: pointer;"><span class="glyphicon glyphicon-edit"></span>Edit Soal</a></td>
                    </tr>
            ';
					...
					foreach ($query_jawaban as $jawaban) {
						...
						$jawaban_table = $jawaban_table . '
	            			<tr>
		                      	...
		                      	<td width="5%">' . $temp_benar . '</td>
		                      	<td width="75%">' . $temp_jawaban . '</td>
		                      	<td width="15%"><a href="' . base_url() . '/manager/modul_jawaban/index/' . $temp->soal_id . '/' . $jawaban->jawaban_id . '" title="Edit Jawaban" style="cursor: pointer;"><span class="glyphicon glyphicon-edit"></span>Edit Jawaban</a></td>
		                    </tr>
	            		';
					}
				}
