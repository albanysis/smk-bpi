...
<section class="content-header">
	<h1>
		Pengaturan SMK BPI
		<small>Melakukan pengaturan Identitas SMK BPI</small>
	</h1>
	<ol class="breadcrumb">
		<li><a href="<?php echo site_url(); ?>/"><i class="fa fa-dashboard"></i> Home</a></li>
		<li class="active">Pengaturan SMK BPI</li>
	</ol>
</section>
		...
		<div class="col-xs-12">
			...
			<div class="box">
				<div class="box-header with-border">
					<div class="box-title">Daftar Pengaturan SMK BPI</div>
				</div><!-- /.box-header -->
