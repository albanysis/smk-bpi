...
<script lang="javascript">
    ...
    function jawaban(id) {
        window.open('<?php echo base_url(); ?>/manager/modul_jawaban/index/' + id);
    }
    ...
    $(function() {
        ...
        $('#form-tambah').submit(function() {
            ...
            $("#modal-proses").modal('show');
            $.ajax({
                url: "<?php echo base_url() . '/' . $url; ?>/tambah",
                type: "POST",
                timeout: 60000,
        ...
        $('#form-hapus-soal').submit(function() {
            $("#modal-proses").modal('show');
            $.ajax({
                url: "<?php echo base_url() . '/' . $url; ?>/hapus_soal",
                type: "POST",
        ...
        $('#form-upload-image').submit(function() {
            ...
            $("#modal-proses").modal('show');
            $.ajax({
                url: "<?php echo base_url() . '/' . $url; ?>/upload_file",
                type: "POST",
                data: new FormData(this),
                mimeType: "multipart/form-data",
                contentType: false,
        ...
        $(document).ready(function() {
            ...
            $('#table-soal').DataTable({
                ...
                "sAjaxSource": "<?php echo base_url() . '/' . $url; ?>/get_datatable/",
                "autoWidth": false,
            ...
            $('#table-image').DataTable({
                ...
                "sAjaxSource": "<?php echo base_url() . '/' . $url; ?>/get_datatable_image/",
                "autoWidth": false,
                "fnServerParams": function(aoData) {
                    aoData.push({
                        "name": "topik",
