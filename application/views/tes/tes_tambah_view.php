...
<script lang="javascript">
    ...
    function refresh_topik() {
        ...
        $.getJSON('<?php echo base_url() . '/' . $url; ?>/get_topik_by_modul/' + modul, function(data) {
            if (data.data == 1) {
    ...
    function edit(id) {
        $("#modal-proses").modal('show');
        $.getJSON('<?php echo base_url() . '/' . $url; ?>/get_by_id/' + id + '', function(data) {
            if (data.data == 1) {
    ...
    function hapus_soal(id) {
        $("#modal-proses").modal('show');
        $.getJSON('<?php echo base_url() . '/' . $url; ?>/hapus_soal_by_id/' + id + '', function(data) {
            if (data.data == 1) {
    ...
    $(function() {
        ...
        $('#btn-tambah-selesai').click(function() {
            window.open("<?php echo base_url(); ?>/manager/tes_tambah", "_self");
        });

        $('#btn-tambah-daftar').click(function() {
            window.open("<?php echo base_url(); ?>/manager/tes_daftar", "_self");
        });
        ...
        $('#form-tambah-tes').submit(function() {
            $("#modal-proses").modal('show');
            $.ajax({
                url: "<?php echo base_url() . '/' . $url; ?>/tambah_tes",
                type: "POST",
        ...
        $('#form-tambah-soal').submit(function() {
            $("#modal-proses").modal('show');
            $.ajax({
                url: "<?php echo base_url() . '/' . $url; ?>/tambah_soal",
                type: "POST",
        ...
        $('#table-soal').DataTable({
            ...
            "sAjaxSource": "<?php echo base_url() . '/' . $url; ?>/get_datatable_soal/",
            "autoWidth": false,
