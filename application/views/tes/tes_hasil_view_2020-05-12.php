...
<script lang="javascript">
    ...
    function detail_tes(tesuser_id) {
        window.open("<?php echo base_url() . '/manager/tes_hasil_detail'; ?>/index/" + tesuser_id);
    }
    ...
    function export_excel() {
        ...
        window.open("<?php echo base_url() . '/' . $url; ?>/export/" + tes + "/" + group + "/" + waktu + "/" + urutkan, "_self");
    }
    ...
    $(function() {
        ...
        $('#form-edit').submit(function() {
            $("#modal-proses").modal('show');
            $.ajax({
                url: "<?php echo base_url() . '/' . $url; ?>/edit_tes",
                type: "POST",
