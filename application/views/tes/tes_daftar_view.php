                ...
                <div class="box-header with-border">
                    ...
                    <div class="box-tools pull-right">
                        <div class="dropdown pull-right">
                            <a href="<?php echo base_url(); ?>/manager/tes_tambah">Tambah Tes</a>
                        </div>
                    </div>
                </div><!-- /.box-header -->
...
<script lang="javascript">
    ...
    function edit(id) {
        window.open("<?php echo base_url(); ?>/manager/tes_tambah/index/" + id, "_self");
    }
    ...
    $(function() {
        ...
        $('#form-hapus').submit(function() {
            $("#modal-proses").modal('show');
            $.ajax({
                url: "<?php echo base_url() . '/' . $url; ?>/hapus_tes",
                type: "POST",
