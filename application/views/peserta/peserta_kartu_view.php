    ...
    <div class="row">
        <div class="col-md-12">
            <div class="callout callout-info">
                <h4>Informasi</h4>
                <p>Lakukan Pengaturan nama pelaksana Ujian sebelum mencetak kartu peserta agar kartu sesuai dengan Organisasi tempat anda melaksanakan Tes.</p>
...
<script lang="javascript">
    $(function() {
        $('#kartu').click(function() {
            ...
            window.open("<?php echo base_url() . '/' . $url; ?>/cetak_kartu/" + grup_id);
        });
    });
</script>