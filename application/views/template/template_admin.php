...
<head>
  ...
  <link rel="shortcut icon" href="<?= base_url(); ?>public/images/bpi.png">
  <!-- Tell the browser to be responsive to screen width -->
  <meta content='width=device-width, initial-scale=1, maximum-scale=10, user-scalable=yes' name='viewport'>
  <meta name="description" content="Aplikasi Ujian Online SMK BPIS">
  <meta name="keywords" content="Aplikasi Ujian Online SMK BPI">
  <meta name="author" content="Albany Siswanto">
  <!-- Bootstrap 3.3.4 -->
...
<body class="skin-green sidebar-mini">
  <div class="wrapper">
    ...
    <header class="main-header">
      ...
      <!-- Logo -->
      <a href="<?php echo base_url(); ?>/manager" class="logo">
        <!-- mini logo for sidebar mini 50x50 pixels -->
        <span class="logo-mini"><b>BPI</b></span>
        <!-- logo for regular state and mobile devices -->
        <span class="logo-lg"><b>SMK BPI</b></span>
      </a>
              ...
              <ul class="dropdown-menu">
                ...
                <li class="user-footer">
                  ...
                  <div class="pull-right">
                    <a href="<?php echo base_url(); ?>/manager/welcome/logout" class="btn btn-default btn-flat">Sign out</a>
                  </div>
                </li>
              </ul>
            </li>
    ...
    <aside class="main-sidebar">
      ...
      <section class="sidebar">
        ...
        <ul class="sidebar-menu">
          ...
          <li><a href="<?php echo base_url(); ?>/manager"><i class="fa fa-dashboard"></i> <span>Dashboard</span></a></li>
    ...
    <footer class="main-footer">
      ...
      <strong>&copy; 2022 <a href="https://twitter.com/albanysiswanto" style="color: #444444;">albanysiswanto</a>-smk bpi bandung</strong>
    </footer>
  ...
  <script>
    $(function() {
      ...
      $('#form-password').submit(function() {
        $.ajax({
          url: "<?php echo base_url(); ?>/manager/dashboard/password",
          type: "POST",
