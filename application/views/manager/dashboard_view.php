...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        <li><a href="<?php echo base_url(); ?>/manager"><i class="fa fa-dashboard"></i> Home</a></li>
...
<section class="content">
    ...
    <div class="callout callout-info">
        <h4>Informasi</h4>
        <p>Ini adalah area administratif SMK BPI, yang memiliki platform dan bahasa user-friendly untuk membuat, mengelola dan melaksanakan ujian online.</p>
    </div>
    <div class="box">
